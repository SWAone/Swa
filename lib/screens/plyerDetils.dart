                  ...
                  ? Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: ineed.custmText(
                              data: 'ارشيف الاعب', fontSize: 20.sp),
                        ),
                        archef(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                detilsCont(
                                  title: "السكن",
                                  body: controller.from,
                                ),
                                detilsCont(
                                  body: controller.feedback,
                                  title: "التقيم",
                                ),
                                detilsCont(
                                  title: "التولد",
                                  body: controller.born,
                                )
                              ],
                            )
                          ],
                  ...
                  : Shimmer.fromColors(
                      child: Column(
                        ...
                        children: [
                            ...
                            child: Stack(
                              children: [
                                ...
                                Align(
                                    alignment: Alignment.centerRight,
                                    child:
                                        Image.asset('assets/images/cr7.png')),
                                Align(
                                    alignment: Alignment.topLeft,
                                    child: Container(
                                      child: Image.asset(
                          ...
                          ineed.custmText(
                              data: 'معلومات اخرى', fontSize: 20.sp),
                          SizedBox(
                            height: 10.h,
                          ),
                          Column(
